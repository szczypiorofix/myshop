...
use Templates\Components\MainPanelCheckoutComponent;

class CheckOutView extends \Core\Framework\MVC\View {
    ...
    */
    public function show($params) {
        ...
        $page['mainpanel'] = MainPanelCheckoutComponent::getContent();
